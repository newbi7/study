...
import cv2
image = cv2.imread('Downloads\Lenna.png', -1)
...
영상 이진화
cv2.threshold(image, thresh_val, max_val, cv2.BINARY_THRESHs)
...
https://shorturl.at/chALP
https://colab.research.google.com/drive/1BB8H-UQtGdZmDGDfDKJslWRbNBKHPHi8?usp=sharing#scrollTo=V_sgB_5dx1f1
``` -->
